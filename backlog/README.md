...
| [US-006](US-006-fix-gaussian-pass0-clip-growth-radiusy.md) | Grow the Gaussian pass-0 clip by the vertical radius | ✅ Done in the working tree (2026-09-25, uncommitted); reproduced (11-110 step band), `getPassResultBounds` grows the pass-0 clip by `inputRadiusY`, `GaussianPassClipGrowthTest`, D3D/ES2/SW check | Commit, then remove this row and the story file |
